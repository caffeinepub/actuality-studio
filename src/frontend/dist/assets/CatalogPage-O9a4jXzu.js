import { c as createLucideIcon, H as createContextScope, o, I as useComposedRefs, j as jsxRuntimeExports, J as createSlot, r as reactExports, K as reactDomExports, N as Primitive, O as useLayoutEffect2, Q as useCallbackRef, R as useControllableState, U as useId, V as composeEventHandlers, W as Portal$1, Y as hideOthers, Z as useFocusGuards, $ as ReactRemoveScroll, a0 as FocusScope, a1 as DismissableLayer, a as cn, a2 as useActor, b as LoaderCircle, X, u as useInternetIdentity, a3 as useCatalogEntries, B as Bookmark, a4 as useItemRating } from "./index-Cm56HytI.js";
...
import { P as Plus } from "./plus-CNTjvOuj.js";
...
function guessCategory(product) {
  ...
  if (/furniture|sofa|chair|table|bed|shelf|shelving|cabinet|couch|desk/.test(
    text
  ))
    return "Furniture Collections";
  if (/adu|studio|loft|unit|module|modular|shell/.test(text))
    return "ADU Shells";
  if (/window|door|brick|tile|panel|facade|ceiling|floor|cladding|trim/.test(text))
...
function autoTags(product) {
  const words = `${product.title} ${product.description}`.toLowerCase().replace(/[^a-z0-9\s-]/g, " ").split(/\s+/).filter((w) => w.length > 2 && !STOP_WORDS.has(w));
  return [...new Set(words)].slice(0, 8);
}
function LocalRatingWidget({ itemId }) {
  const [localRating, setLocalRating] = reactExports.useState(null);
  const [upvotes, setUpvotes] = reactExports.useState(0);
  const [downvotes, setDownvotes] = reactExports.useState(0);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-1 px-2 py-1 rounded-full text-xs font-body font-semibold transition-colors duration-150 ${localRating === 1 ? "bg-primary text-primary-foreground" : "bg-muted/40 text-foreground/50 hover:bg-primary/10 hover:text-primary"}`,
            children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-1 px-2 py-1 rounded-full text-xs font-body font-semibold transition-colors duration-150 ${localRating === -1 ? "bg-destructive text-destructive-foreground" : "bg-muted/40 text-foreground/50 hover:bg-destructive/10 hover:text-destructive"}`,
            children: [
...
function ResultCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `group rounded-xl border transition-all duration-200 overflow-hidden flex flex-col bg-card ${isSelected ? "border-primary shadow-md ring-2 ring-primary/30" : "border-border/30 hover:border-primary/40 hover:shadow-sm"}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden bg-muted/20", children: [
          ...
          isUploaded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2 right-2 flex items-center gap-1 bg-primary text-primary-foreground text-xs font-body font-bold px-2 py-0.5 rounded-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3 h-3" }),
            "Added"
          ] }),
          product.source && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-2 left-2 text-xs font-body font-semibold bg-background/80 text-foreground/60 px-2 py-0.5 rounded-full backdrop-blur-sm", children: product.source })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-sm font-semibold text-foreground line-clamp-2 leading-snug mb-1", children: product.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/60 line-clamp-3 leading-relaxed mb-3 flex-1", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-base font-bold text-primary", children: product.price ? product.price.startsWith("$") ? product.price : `$${product.price}` : "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(LocalRatingWidget, { itemId: product.id })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: product.purchaseUrl || `https://www.amazon.com/s?k=${encodeURIComponent(product.title)}`,
                  target: "_blank",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `flex items-center justify-center gap-1 py-1.5 px-2 rounded-lg text-xs font-body font-semibold transition-colors ${isSelected ? "bg-primary/20 text-primary border border-primary/30" : "bg-primary/10 text-primary hover:bg-primary/20"}`,
                  children: isSelected ? "Selected ✓" : "Select & Tag"
                }
              )
            ] })
          ] })
...
function TagUploadPanel({
  ...
  const [tags, setTags] = reactExports.useState(() => autoTags(product));
  const [newTag, setNewTag] = reactExports.useState("");
  const [category, setCategory] = reactExports.useState(() => guessCategory(product));
  const [price, setPrice] = reactExports.useState(() => product.price || "");
  const [sourceUrl, setSourceUrl] = reactExports.useState(
    () => product.purchaseUrl || `https://www.amazon.com/s?k=${encodeURIComponent(product.title)}`
  );
  const [imgError, setImgError] = reactExports.useState(false);
  ...
  const handleUpload = () => {
    ...
    ue.success(`"${product.title}" added to Catalog!`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-base font-bold text-foreground mb-0.5 truncate", children: product.title }),
            product.source && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/50 mb-1", children: product.source }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/60 line-clamp-2", children: product.description })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5", children: "Price" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 font-body text-sm text-muted-foreground", children: "$" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1.5", children: "Source / Order URL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Suggested Tags" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Badge,
            {
              variant: "outline",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: category, onValueChange: setCategory, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "font-body", children: ACTUALITY_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: cat, children: cat }, cat)) })
          ] })
        ] }),
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-primary/20 bg-muted/30 p-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-5 h-5 text-primary mx-auto mb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-semibold text-foreground/80 mb-1", children: "Members can upload to the Catalog" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mb-3", children: "Sign in and select a membership plan to start adding items and receive member discounts." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
...
function FindItemsPanel({
  ...
  const [uploadedIds, setUploadedIds] = reactExports.useState(/* @__PURE__ */ new Set());
  ...
  const handleUpload = (entry) => {
    if (selectedProduct) {
      setUploadedIds((prev) => /* @__PURE__ */ new Set([...prev, selectedProduct.id]));
    }
    onAddEntry(entry);
    setSelectedProduct(null);
  };
  const isActorReady = !!actor;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border/20 rounded-2xl overflow-hidden bg-card/50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2 font-body text-sm font-semibold text-foreground/80", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-5 pt-1 border-t border-border/20", children: [
          ...
          !isActorReady && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground mt-2 flex items-center gap-1.5", children: [
          ...
          isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-muted-foreground", children: "Searching shops and markets…" })
              ]
            }
          ),
          !isLoading && !hasSearched && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-8 h-8 text-muted-foreground/40 mx-auto mb-2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "Search for furniture, fixtures, tools, building materials and more…" })
          ] }),
          !isLoading && hasSearched && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-muted-foreground", children: [
                ...
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground/70", children: [
                  '"',
                  submittedQuery,
                  '"'
                ] }),
          ...
          !isLoading && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
                ...
                children: [
                  ...
                  " item",
                  results.length !== 1 ? "s" : "",
                  " found — select to tag and upload to catalog"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                className: "\n                      [column-count:1]\n                      sm:[column-count:2]\n                      md:[column-count:3]\n                      lg:[column-count:4]\n                      xl:[column-count:5]\n                      [column-gap:1rem]\n                    ",
                children: results.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "mb-4",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        product,
                        isSelected: (selectedProduct == null ? void 0 : selectedProduct.id) === product.id,
                        isUploaded: uploadedIds.has(product.id),
                        onSelect: () => setSelectedProduct(
                          (selectedProduct == null ? void 0 : selectedProduct.id) === product.id ? null : product
                        )
                      }
                    )
                  },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedProduct && /* @__PURE__ */ jsxRuntimeExports.jsx(
              TagUploadPanel,
              {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        onClick: () => handleRate(1),
        className: `flex items-center gap-1 px-2 py-1 rounded-full text-xs font-body font-medium transition-all duration-200 border ${isUpActive ? "bg-primary/15 border-primary/40 text-primary" : isAuthenticated ? "border-border/40 text-foreground/40 hover:border-primary/40 hover:text-primary hover:bg-primary/5" : "border-border/20 text-foreground/25 cursor-not-allowed"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ThumbsUp,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ratings.upvotes })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        onClick: () => handleRate(-1),
        className: `flex items-center gap-1 px-2 py-1 rounded-full text-xs font-body font-medium transition-all duration-200 border ${isDownActive ? "bg-destructive/15 border-destructive/40 text-destructive" : isAuthenticated ? "border-border/40 text-foreground/40 hover:border-destructive/40 hover:text-destructive hover:bg-destructive/5" : "border-border/20 text-foreground/25 cursor-not-allowed"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ThumbsDown,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ratings.downvotes })
        ]
      }
    )
  ] });
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            ...
            height: 427,
            onError: (e) => {
              e.currentTarget.src = "/assets/generated/mckinley-exterior.dim_900x600.jpg";
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-sm sm:text-base font-semibold text-foreground leading-snug min-w-0", children: entry.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-xs font-body text-foreground/40 bg-muted/40 px-2 py-0.5 rounded-full whitespace-nowrap", children: entry.category })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/60 leading-relaxed mb-2", children: entry.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 mb-2", children: entry.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
          ...
          entry.price && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-block font-body text-sm font-bold text-primary bg-primary/10 px-3 py-0.5 rounded-full", children: [
            "$",
            entry.price
          ] }) }),
          entry.sourceUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2 pt-2 border-t border-border/20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                className: `flex items-center gap-1 text-xs font-body transition-all duration-200 ${isSaved ? "text-primary font-semibold" : "text-foreground/50 hover:text-primary"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Bookmark,
                    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      ...
      children: [
        ...
        " for",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("em", { className: "not-italic font-semibold text-foreground/70", children: [
          '"',
          query,
          '"'
        ] })
...
function CatalogPage() {
  ...
  const baseEntries = entries && entries.length > 0 ? entries : SEED_ENTRIES;
  const allEntries = [...baseEntries, ...extraEntries];
  const filteredEntries = allEntries.filter((entry) => {
    const matchesCategory = activeCategory === "All" || entry.category === activeCategory;
    const q = searchQuery.trim().toLowerCase();
    const matchesSearch = !q || entry.title.toLowerCase().includes(q) || entry.description.toLowerCase().includes(q) || entry.category.toLowerCase().includes(q) || entry.tags.some((t) => t.toLowerCase().includes(q));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-[oklch(0.95_0.03_78_/_0.6)] to-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.span,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "sticky top-0 z-20 bg-background/95 backdrop-blur-sm border-b border-border/20 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-lg", children: [
          ...
          activeSearch && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-4 bg-muted/20 border-b border-border/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      FindItemsPanel,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "pb-16 sm:pb-20 lg:pb-28 pt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: entriesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    ) : error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20", "data-ocid": "catalog.error_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-destructive", children: "Failed to load catalog entries." }) }) : filteredEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20", "data-ocid": "catalog.empty_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg font-semibold text-foreground/50 mb-2", children: "No items found" }),
      activeSearch && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-foreground/40", children: [
          'No results match "',
          activeSearch,
          '"'
        ] }),
      ...
      featuredEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-base font-semibold text-foreground/60 mb-4 tracking-widest uppercase text-sm", children: "Spotlight" }),
      ...
      remainingEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        featuredEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-base font-semibold text-foreground/60 mb-4 tracking-widest uppercase text-sm", children: "All Items" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            "data-ocid": "catalog.masonry_grid",
            style: {
              columnCount: "var(--masonry-cols)",
              columnGap: "1rem"
            },
            className: "[--masonry-cols:1] sm:[--masonry-cols:2] lg:[--masonry-cols:3] xl:[--masonry-cols:4] 2xl:[--masonry-cols:5]",
            children: remainingEntries.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                initial: { opacity: 0, y: 16 },
                animate: { opacity: 1, y: 0 },
