import { c as createLucideIcon, j as jsxRuntimeExports, b as Link, r as reactExports, F as createContextScope, p as Primitive, n as cn, u as useInternetIdentity, a as useGetCallerMembershipState, G as useTrialStatus, e as useMintBadge, L as LoaderCircle, l as LogIn, T as TriangleAlert, C as Clock, M as MemberCategory } from "./index-AoDEp7ME.js";
import { u as useImageReveal } from "./useImageReveal-CKSLTk1E.js";
import { E as EnrollmentModal, S as Shield } from "./EnrollmentModal-BvSpLihA.js";
import { m as motion } from "./proxy-BdlwTt1i.js";
import "./plus-BNB9Nuff.js";
import "./circle-check-big-CGtWlWNs.js";
/**
...
function AboutSection() {
  const { ref: img1Ref } = useImageReveal();
  const { ref: img2Ref } = useImageReveal();
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 grid grid-cols-2 gap-3 sm:gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  ref: img1Ref,
                  className: `rounded-xl overflow-hidden aspect-[4/3] shadow-warm ${"image-reveal-visible"}`,
...
function HeroSection() {
  ...
  const { ref: heroImgRef } = useImageReveal({});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ref: heroImgRef,
        className: `w-full aspect-[21/9] overflow-hidden ${"image-reveal-visible"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
...
function InspirationCarousel() {
  ...
  const { ref: sectionRef } = useImageReveal({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 sm:py-20 lg:py-24 bg-spring overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      {
        ref: sectionRef,
        className: `relative rounded-2xl overflow-hidden shadow-2xl ${"image-reveal-visible"}`,
        children: [
...
function ProductCard({ product, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `group bg-background rounded-2xl border border-border/30 shadow-warm overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${"image-reveal-visible"}`,
      children: [
