const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-AoDEp7ME.js","assets/index-BDekNX4E.css"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, j as jsxRuntimeExports, n as cn, r as reactExports, p as Primitive, u as useInternetIdentity, q as useNavigate, s as useHasAnyAdmin, t as useIsCallerAdmin, v as useListAdmins, w as useRegisterAsFirstAdmin, x as useAddAdmin, y as useRemoveAdmin, S as ShieldCheck, L as LoaderCircle, _ as __vitePreload } from "./index-AoDEp7ME.js";
import { I as Input, B as Button, u as ue, S as SignInOverlay } from "./SignInOverlay-D3Qnrs8J.js";
import { u as useDiscountRates, D as DEFAULT_RATES } from "./useDiscountRates-DsHcT6QJ.js";
  ...
  const handleAddAdmin = async () => {
    ...
    try {
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-AoDEp7ME.js").then((n) => n.a1);
