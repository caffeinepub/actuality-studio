const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DA2SeFgQ.js","assets/index-BSLdItzB.css"])))=>i.map(i=>d[i]);
import { a as createLucideIcon, j as jsxRuntimeExports, c as cn, r as reactExports, u as useInternetIdentity, p as useNavigate, q as useHasAnyAdmin, s as useIsCallerAdmin, t as useListAdmins, w as useRegisterAsFirstAdmin, x as useAddAdmin, y as useRemoveAdmin, S as ShieldCheck, b as LoaderCircle, _ as __vitePreload } from "./index-DA2SeFgQ.js";
import { m as motion, I as Input, B as Button } from "./proxy-DHlry1-0.js";
import { L as Label } from "./label-7_kNpLMS.js";
import { u as ue, S as SignInOverlay } from "./SignInOverlay-BtJwRLIi.js";
import { u as useDiscountRates, D as DEFAULT_RATES } from "./useDiscountRates-DJ5jcu5-.js";
  ...
  const handleAddAdmin = async () => {
    ...
    try {
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-DA2SeFgQ.js").then((n) => n.a2);
