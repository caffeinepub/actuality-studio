import { c as createLucideIcon, j as jsxRuntimeExports, A as Slot$1, n as cn, F as createContextScope, o, H as useComposedRefs, I as createSlot, r as reactExports, J as reactDomExports, p as Primitive, K as useLayoutEffect2, N as useCallbackRef, O as useControllableState, Q as useId, R as composeEventHandlers, U as Portal$1, V as hideOthers, W as useFocusGuards, Y as ReactRemoveScroll, Z as FocusScope, $ as DismissableLayer, L as LoaderCircle, X, u as useInternetIdentity, a0 as useCatalogEntries, B as Bookmark } from "./index-AoDEp7ME.js";
import { c as cva, A as AnimatePresence, I as Input, B as Button, u as ue, S as SignInOverlay } from "./SignInOverlay-D3Qnrs8J.js";
import { C as Check } from "./check-BqVm7uvz.js";
import { m as motion } from "./proxy-BdlwTt1i.js";
import { P as Plus } from "./plus-BNB9Nuff.js";
import { u as useImageReveal } from "./useImageReveal-CKSLTk1E.js";
/**
...
function ResultCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      onClick: onSelect,
      className: `text-left group rounded-xl border transition-all duration-200 overflow-hidden ${isSelected ? "border-primary shadow-md ring-2 ring-primary/30" : "border-border/30 hover:border-primary/40 hover:shadow-sm"}`,
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-sm font-semibold text-foreground line-clamp-1 mb-0.5", children: product.title }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-xs font-semibold text-primary", children: [
              "$",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-5 pt-1 border-t border-border/20", children: [
          ...
          !isLoading && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-foreground/50 mt-3 mb-2", children: [
              results.length,
              " items found — click one to tag and upload to catalog"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: results.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
...
function CatalogCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `group relative bg-background rounded-2xl border border-border/30 shadow-warm overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${"image-reveal-visible"} ${featured ? "md:col-span-2" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
