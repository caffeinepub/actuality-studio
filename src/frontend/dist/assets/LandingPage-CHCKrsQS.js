import { a as createLucideIcon, r as reactExports, j as jsxRuntimeExports, d as Link, c as cn, t as useIsCallerAdmin, E as createContextScope, P as Primitive, u as useInternetIdentity, b as useGetCallerMembershipState, F as useTrialStatus, f as useMintBadge, L as LoaderCircle, m as LogIn, T as TriangleAlert, C as Clock, M as MemberCategory } from "./index-7MseRzpB.js";
import { B as Badge } from "./badge-BGpiedPe.js";
import { A as AnimatePresence, m as motion, B as Button, I as Input } from "./proxy-DiD02iR5.js";
import { L as Label } from "./label-C7T6N5yX.js";
import { T as Trash2, E as EnrollmentModal, S as Shield } from "./EnrollmentModal-CvgNdTKx.js";
import { P as Plus } from "./plus-B4gXIh-A.js";
import "./circle-check-big-DBpYLfsc.js";
/**
...
function AboutSection() {
  const [img1Loaded, setImg1Loaded] = reactExports.useState(false);
  const [img2Loaded, setImg2Loaded] = reactExports.useState(false);
...
function CatalogPreviewCarousel() {
  ...
  const handleAdd = () => {
    ...
    const added = {
      ...
      imageUrl: newProduct.imageUrl.trim() || "/assets/generated/adu-shell-type-a.dim_600x400.png"
    };
...
function HeroSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full aspect-[21/9] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
