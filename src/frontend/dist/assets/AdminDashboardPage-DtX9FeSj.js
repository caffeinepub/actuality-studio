const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-9epJpKfF.js","assets/index-DpRBIghi.css"])))=>i.map(i=>d[i]);
import { a as createLucideIcon, j as jsxRuntimeExports, c as cn, r as reactExports, u as useInternetIdentity, q as useNavigate, s as useHasAnyAdmin, t as useIsCallerAdmin, w as useListAdmins, x as useRegisterAsFirstAdmin, y as useAddAdmin, z as useRemoveAdmin, A as ShieldCheck, L as LoaderCircle, _ as __vitePreload } from "./index-9epJpKfF.js";
import { m as motion, I as Input, B as Button } from "./proxy-DwolodER.js";
import { L as Label } from "./label-QNstXCCK.js";
import { u as ue, S as SignInOverlay } from "./SignInOverlay-BhzpuOKJ.js";
import { u as useDiscountRates, D as DEFAULT_RATES } from "./useDiscountRates-CH-p2mHq.js";
  ...
  const handleAddAdmin = async () => {
    ...
    try {
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-9epJpKfF.js").then((n) => n.a1);
