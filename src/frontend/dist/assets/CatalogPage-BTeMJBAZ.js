import { a as createLucideIcon, E as createContextScope, o, G as useComposedRefs, j as jsxRuntimeExports, H as createSlot, r as reactExports, I as reactDomExports, P as Primitive, J as useLayoutEffect2, K as useCallbackRef, N as useControllableState, O as useId, Q as composeEventHandlers, R as Portal$1, U as hideOthers, V as useFocusGuards, W as ReactRemoveScroll, Y as FocusScope, Z as DismissableLayer, c as cn, L as LoaderCircle, X, u as useInternetIdentity, $ as useCatalogEntries, B as Bookmark } from "./index-ZyXTS-MD.js";
import { A as AnimatePresence, m as motion, I as Input, B as Button } from "./proxy-CrPyNBgE.js";
import { B as Badge } from "./badge-DPrkgPgJ.js";
import { C as Check } from "./check-CCDByUnr.js";
import { u as ue, S as SignInOverlay } from "./SignInOverlay-BtdXIKHz.js";
import { P as Plus } from "./plus--90cCsrF.js";
/**
...
function autoTags(product) {
  const words = `${product.title} ${product.description} ${product.category}`.toLowerCase().replace(/[^a-z0-9\s-]/g, " ").split(/\s+/).filter((w) => w.length > 2 && !STOP_WORDS.has(w));
  const fromApi = product.tags ?? [];
  const all = [.../* @__PURE__ */ new Set([...fromApi, ...words])];
...
function ResultCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `group rounded-xl border transition-all duration-200 overflow-hidden flex flex-col ${isSelected ? "border-primary shadow-md ring-2 ring-primary/30" : "border-border/30 hover:border-primary/40 hover:shadow-sm"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video overflow-hidden bg-muted/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: onSelect, className: "text-left mb-2", children: [
            ...
            product.brand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/50 mb-1", children: product.brand }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/60 line-clamp-3 leading-relaxed", children: product.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pt-2 border-t border-border/15", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-base font-bold text-primary", children: [
                "$",
                product.price.toFixed(2)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-body text-foreground/40 bg-muted/40 px-2 py-0.5 rounded-full capitalize", children: product.category })
            ] }),
...
function TagUploadPanel({
  ...
  const [price, setPrice] = reactExports.useState(() => product.price.toFixed(2));
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-base font-bold text-foreground mb-0.5", children: product.title }),
            product.brand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/50 mb-1", children: product.brand }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-foreground/60 uppercase tracking-wide mb-1.5", children: "Price" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 font-body text-sm text-foreground/50", children: "$" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-foreground/60 uppercase tracking-wide mb-1.5", children: "Source / Order URL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/50 italic mb-4 bg-background/40 rounded-lg px-3 py-2 border border-border/20", children: "Members can save this item with pricing and a direct order link visible in their personal catalog." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-foreground/60 uppercase tracking-wide mb-2", children: "Suggested Tags" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs font-semibold text-foreground/60 uppercase tracking-wide mb-2", children: "Category" }),
        ...
        isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-primary/20 bg-[#f5e6c8]/60 p-4 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-foreground/55 mb-3", children: "Sign in and select a membership plan to start adding items and receive member discounts." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
...
function FindItemsPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border/20 rounded-2xl overflow-hidden bg-[#f5e6c8]/25", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-4 h-4 text-foreground/50" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-4 h-4 text-foreground/50" })
        ]
      }
    ),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-5 pt-1 border-t border-border/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : "Search"
              }
            )
          ] }),
          isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-foreground/60", children: "Searching shops and markets…" })
              ]
            }
          ),
          !isLoading && hasSearched && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-foreground/50", children: [
                "No items found for",
                " ",
          ...
          !isLoading && results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-foreground/50 mt-3 mb-2", children: [
              results.length,
              " items found — click an item to tag and upload to catalog"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: results.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              uploadedIds.has(product.id) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 z-10 bg-primary text-primary-foreground text-xs font-body font-bold px-2 py-0.5 rounded-full", children: "Added" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ResultCard,
                {
                  product,
...
function CatalogCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `group relative bg-background rounded-2xl border border-border/30 shadow-warm overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${featured ? "md:col-span-2" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-5", children: [
          ...
          entry.price && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-block font-body text-sm font-bold text-primary bg-primary/10 px-3 py-1 rounded-full", children: [
            "$",
            entry.price
          ] }) }),
...
function CatalogPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-4 bg-background/80", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      FindItemsPanel,
      {
