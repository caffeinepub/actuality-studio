import { j as jsxRuntimeExports, C as Clock, L as LoaderCircle, r as reactExports } from "./index-CywzjWOn.js";
import { E as EnrollmentModal } from "./EnrollmentModal-DrjFIztD.js";
...
function MembershipTierCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      className: `
        relative bg-background rounded-2xl border shadow-warm
        flex flex-col h-full
        transition-all duration-300 hover:-translate-y-1 hover:shadow-lg
        ${featured ? `${accent.border} border-2` : "border-border/30"}
      `,
      children: [
        featured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 sm:p-6 lg:p-7 flex flex-col flex-1", children: [
