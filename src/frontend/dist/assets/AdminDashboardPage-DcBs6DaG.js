const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-FFX2L6Pj.js","assets/index-Cwoj0A-9.css"])))=>i.map(i=>d[i]);
import { a as createLucideIcon, j as jsxRuntimeExports, c as cn, r as reactExports, u as useInternetIdentity, q as useNavigate, s as useHasAnyAdmin, t as useIsCallerAdmin, w as useListAdmins, x as useRegisterAsFirstAdmin, y as useAddAdmin, z as useRemoveAdmin, A as ShieldCheck, L as LoaderCircle, _ as __vitePreload } from "./index-FFX2L6Pj.js";
import { m as motion, I as Input, B as Button } from "./proxy-CmOQ4Dsr.js";
import { L as Label } from "./label-BA7mqUGE.js";
import { u as ue, S as SignInOverlay } from "./SignInOverlay-DAh6wcQz.js";
import { u as useDiscountRates, D as DEFAULT_RATES } from "./useDiscountRates-CtiG_LYj.js";
import "./circle-check-big-C4RrH7-5.js";
/**
  ...
  const handleAddAdmin = async () => {
    ...
    try {
      const { Principal } = await __vitePreload(async () => {
        const { Principal: Principal2 } = await import("./index-FFX2L6Pj.js").then((n) => n.a1);
