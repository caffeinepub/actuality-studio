...
export class Backend implements backendInterface {
    ...
    async createCohort(arg0: Array<CohortMember>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCohort(to_candid_vec_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createTrialMembership(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createTrialMembership();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMemberships(): Promise<Array<MembershipState>> {
        if (this.processError) {
            try {
    ...
    async getCallerMembershipState(): Promise<MembershipState> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerMembershipState();
                return from_candid_MembershipState_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCohort(): Promise<Cohort | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCohort();
    ...
    async getDiscountRates(): Promise<DiscountRates> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiscountRates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMemberCohort(arg0: Principal): Promise<Cohort> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemberCohort(arg0);
                return from_candid_Cohort_n25(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getMembershipState(arg0: Principal): Promise<MembershipState> {
        if (this.processError) {
            try {
                const result = await this.actor.getMembershipState(arg0);
                return from_candid_MembershipState_n16(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSavedCatalogItems(): Promise<Array<SavedCatalogItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSavedCatalogItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAdmins(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async mintBadge(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.mintBadge();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerAsFirstAdmin(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerAsFirstAdmin();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeSavedCatalogItem(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeSavedCatalogItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCatalogItem(arg0: SavedCatalogItem): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setDiscountRates(arg0: DiscountRates): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDiscountRates(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CohortMember_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CohortMember): CohortMember {
    return from_candid_record_n29(_uploadFile, _downloadFile, value);
}
function from_candid_Cohort_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Cohort): Cohort {
    return from_candid_record_n26(_uploadFile, _downloadFile, value);
}
function from_candid_MemberCategory_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MemberCategory): MemberCategory {
    return from_candid_variant_n19(_uploadFile, _downloadFile, value);
}
function from_candid_MemberRole_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MemberRole): MemberRole {
    return from_candid_variant_n31(_uploadFile, _downloadFile, value);
}
function from_candid_MembershipState_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MembershipState): MembershipState {
...
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        badgeMinted: value.badgeMinted,
        category: from_candid_MemberCategory_n18(_uploadFile, _downloadFile, value.category),
        trialEndsAt: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.trialEndsAt))
    };
}
function from_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        members: from_candid_vec_n27(_uploadFile, _downloadFile, value.members),
        owner: value.owner,
...
function from_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "trial" in value ? MemberCategory.trial : "premium" in value ? MemberCategory.premium : "standard" in value ? MemberCategory.standard : value;
}
...
function from_candid_variant_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "professional" in value ? MemberRole.professional : "friend" in value ? MemberRole.friend : "family" in value ? MemberRole.family : value;
}
function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MembershipState>): Array<MembershipState> {
    return value.map((x)=>from_candid_MembershipState_n16(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CohortMember>): Array<CohortMember> {
    return value.map((x)=>from_candid_CohortMember_n28(_uploadFile, _downloadFile, x));
}
function to_candid_CohortMember_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CohortMember): _CohortMember {
    return to_candid_record_n12(_uploadFile, _downloadFile, value);
}
function to_candid_MemberRole_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MemberRole): _MemberRole {
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        principal: value.principal,
        role: to_candid_MemberRole_n13(_uploadFile, _downloadFile, value.role)
    };
}
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MemberRole): {
    professional: null;
} | {
    friend: null;
} | {
    ...
    return value == MemberRole.professional ? {
        professional: null
    } : value == MemberRole.friend ? {
        friend: null
    } : value == MemberRole.family ? {
        family: null
    } : value;
}
...
function to_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<CohortMember>): Array<_CohortMember> {
    return value.map((x)=>to_candid_CohortMember_n11(_uploadFile, _downloadFile, x));
}
